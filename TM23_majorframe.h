...
#define TM23_SFID_CHAN_IDX 1

/*Names of measurements, defined by NASA PCM doc*/
static char   * szTM23SerialChanNames[]    =    {"Subframe ID                 ", "GPS 1PPS                                   ",
...
static char   * szTM23SerialChanAbbrev[]   =    {"SFID",         "GPS",
					         "MF1",          "MF2",
					         "FS1",	         "FS2",
					         "Rx-DSP"};
...
static uint16_t     uTM23AsymFRanges[][2]  =    {{  2, 199}};   //Just for MF2 words, inclusive of words
