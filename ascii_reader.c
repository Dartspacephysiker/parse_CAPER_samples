...
/* 	/\* READ_INT_VAL(D2, szBitsPerSec, ulBitsPerSec)                    // D2 - Bit Rate *\/ */
/* 	/\* READ_INT_VAL(F1, szCommonWordLen, ulCommonWordLen)              // F1 - Common Word Length *\/ */
/* 	/\* READ_INT_VAL(F2, szWordTransferOrder, ulWordTransferOrder)      // F2 - MSB / LSB first *\/ */
/* 	/\* READ_INT_VAL(F3, szParityType, ulParityType)                    // F3 - Even, odd, none *\/ */
/* 	/\* READ_INT_VAL(F4, szParityTransferOrder, ulParityTransferOrder)  // F4 - Leading / Trailing *\/ */
...
#define READ_INT_VAL(pattern, field, ifield)                                 \
